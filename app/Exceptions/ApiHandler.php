...
trait ApiHandler
{
    ...
    /**
     * Retorna erro quando o usuário não tem permissão
     *
     * @param AuthenticationException $e
     * @return JsonResponse
     */
    ...
    {
        return resposta_padrao($e->getMessage(), 'authorization_error', 401);
    }
    ...
    {
        return resposta_padrao($e->getMessage(), "internal_error", 500);
    }
}
